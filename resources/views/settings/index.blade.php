...
<style>
    ...
    .nav-info-card { margin-top: 1.5rem; padding: 1.25rem; background: #fffbeb; border: 1px solid #fef3c7; border-radius: 1.25rem; display: flex; gap: .75rem; }
    .nav-info-card i { color: #d97706; font-size: 1rem; margin-top: 2px; }
    .nav-info-card p { margin: 0; font-size: .75rem; color: #92400e; font-weight: 600; line-height: 1.5; }
    ...
    .form-input:focus { border-color: #6366f1; outline: none; background: #fff; box-shadow: 0 0 0 4px rgba(99, 102, 241, 0.08); }
    ...
    .btn-save { background: #6366f1; color: #fff; border: none; padding: .875rem 2rem; border-radius: 1rem; font-size: .95rem; font-weight: 800; cursor: pointer; display: flex; align-items: center; gap: .75rem; transition: all .2s; }
    .btn-save:hover { background: #4f46e5; transform: translateY(-2px); box-shadow: 0 8px 20px rgba(99, 102, 241, 0.2); }
