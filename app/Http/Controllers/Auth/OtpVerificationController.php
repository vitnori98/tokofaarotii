...
class OtpVerificationController extends Controller
{
    ...
    public function resendOtp(Request $request): RedirectResponse
    {
        ...
        try {
            Mail::to($request->email)->send(new OtpMail($newOtp));
        } catch (\Exception $e) {
            \Log::error('Gagal mengirim ulang email OTP: ' . $e->getMessage());
            return back()->withInput()->withErrors(['email' => 'Gagal mengirim ulang email OTP. Silakan cek koneksi internet atau pengaturan SMTP Anda.']);
        }
